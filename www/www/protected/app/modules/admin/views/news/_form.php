...
<div class="container-fluid">
	<div class="row-fluid">
		<div class="span8 well">
			...
			<br />
			<?php echo $form->textAreaRow($model, 'PostShortContent', array('class'=>'span12', 'rows'=>3)); ?>
			<br />
		...
		<div class="span4 well">
			<fieldset>
				...
				<br />
				<?php echo $form->datepickerRow($model, 'PostPubDate', array('prepend'=>'<i class="icon-calendar"></i>', 'options'=>array('format'=>'yyyy-mm-dd'))).'<br />'; ?>
		...
		<div class="span4 well">
			<fieldset>
				...
				<?php if (realpath('./images/news/thumbs/'.$model->PostId.'.png')) echo CHtml::image('/images/news/thumbs/'.$model->PostId.'.png'); ?>
				</fieldset>
		</div>
